...
/**
 * Provide "make" methods to create instances of {@link FootballServiceApi}
 * and its related dependencies, such as OkHttpClient, Gson, etc.
 */
public class FootballServiceFactory {

    public static FootballServiceApi makeService() {
        OkHttpClient okHttpClient = makeOkHttpClient(makeLoggingInterceptor());
        return makeService(okHttpClient);
    }

    public static FootballServiceApi makeService(OkHttpClient okHttpClient) {
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .build();
        return retrofit.create(FootballServiceApi.class);
    }
